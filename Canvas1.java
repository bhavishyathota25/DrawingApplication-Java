    ...
    public void CanvasView() {
        ...
        canvasPanel.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent e) {
                ...
                grap.setFont(font);
                grap.drawString(text, e.getX(), e.getY());
            }
        });
        toolBar = new JPanel();
        toolBar.setBounds(30, 30, 250, 700);
        ...
        Image brushImg = brushIcon.getImage().getScaledInstance(20, 20, Image.SCALE_SMOOTH);
        Image eraseImg = eraseIcon.getImage().getScaledInstance(20, 20, Image.SCALE_SMOOTH);
        ImageIcon smallBrushIcon = new ImageIcon(brushImg);
        ImageIcon smallEraseIcon = new ImageIcon(eraseImg);

        JButton brush = new JButton(smallBrushIcon);
        brush.setBounds(30, 465, 80, 30);
        toolBar.add(brush);
        JButton erase = new JButton(smallEraseIcon);
        ...
        brush.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                isBrushMode = true;
                brush.setIcon(smallBrushIcon);
                erase.setIcon(smallEraseIcon);
            }
        });
        ...
        textLabel.setBounds(30, 595, 50, 30);
        toolBar.add(textLabel);
        textInput = new JTextField();
        textInput.setBounds(70, 600, 100, 30);
        toolBar.add(textInput);
        JButton addText = new JButton("Add Text");
        addText.setBounds(100, 650, 100, 30);
        toolBar.add(addText);
        addText.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                String text = textInput.getText();
                Graphics grap = canvasPanel.getGraphics();
                grap.setColor(Color.decode(col.getText()));
                grap.setFont(font);
                grap.drawString(text, 100, 100); 
            }
        });
